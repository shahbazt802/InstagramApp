...
//
//        if(item.getItemId()==R.id.postImageItem && item!=null){
//            if(android.os.Build.VERSION.SDK_INT>=23 &&
//            checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
//                requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},3000);
//
              ...
              final ProgressDialog progressDialog=new ProgressDialog(this);
               ...
               parseObject.saveInBackground(new SaveCallback() {
                   ...
                   public void done(ParseException e) {
                       if(e==null) {
                           FancyToast.makeText(SocialMediaActivity.this, "Uploaded Successfull", FancyToast.LENGTH_SHORT, FancyToast.SUCCESS, true).show();
                       }
                       else {
